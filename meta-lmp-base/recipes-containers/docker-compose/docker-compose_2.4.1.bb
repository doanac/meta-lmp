...
go_do_compile() {
	...
	chmod -R +w ${B}/pkg/mod
	cp ${S}/src/github.com/docker/cli/cli/config/config.go ${B}/pkg/mod/github.com/docker/cli@v20.10.3-0.20220309205733-2b52f62e9627+incompatible/cli/config/config.go
